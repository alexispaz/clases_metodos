...
\path<2>(A.north east) ++(-2,-4.5) node(H)[draw=celeste,very thick, inner sep=0,rotate=-5,anchor=east]{\includegraphics[width=2.9cm]{img/burden.png}};
...
\begin{zframe}{}
\path<1->(cp) ++(0,0) node(x)[]{ \includegraphics[width=14cm]{img/messi3.png}};
\path<3->(nw) ++(1,-3) node[verde,fill=black,draw, thick, anchor=north west]{\Large PVF};

\path<2>(cp) ++(0,0) node(x)[inner sep=0, draw, thick, celeste]{ \includegraphics[width=10cm]{img/messi4.png}};
\begin{scope}
...
\path(m-|A.east) ++(0.4,0) node(z)[align=left,anchor=west]{\includegraphics[width=4cm]{img/idiogram/cuerdas2.png}};
...
\path($(x)!.5!(A)$) coordinate(m);
\path(m-|A.east) ++(2,.1) node(x)[align=left,anchor=west]{\includegraphics[width=5cm]{img/idiogram/fourier.png}};
\path(z) node{\includegraphics[width=4cm]{img/idiogram/cuerdas2.png}};
...
\path<2>(c4) ++(2.8,1)  node(H)[draw=naranja,very thick, inner sep=0,rotate=-5,anchor=east]{\includegraphics[width=2.5cm]{img/izaacwang.png}};
...
% \path(ne) ++(-1,-2) node(A)[anchor=north east,rotate=-10]{\includegraphics[width=2cm]{img/gente/belen.png}}; 
