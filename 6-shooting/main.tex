...
\path(m-|A.east) ++(0.4,0) node(z)[align=left,anchor=west]{\includegraphics[width=4cm]{idiogram/cuerdas2.png}};
...
\path($(x)!.5!(A)$) coordinate(m);
\path(m-|A.east) ++(2,.1) node(x)[align=left,anchor=west]{\includegraphics[width=5cm]{idiogram/fourier.png}};
\path(z) node{\includegraphics[width=4cm]{idiogram/cuerdas2.png}};
