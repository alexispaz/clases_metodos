...
% \path(A.-90) ++(0,-0.5) node(A)[anchor=north]{\color{lila} Agosto 7, 2023};
\path(vl) ++(0,0) node(A)[anchor=north]{\includegraphics[width=4cm]{logos/DQTC_orange.png}};
...
\path(cp) ++(1.5,0.) node[rotate=-10]{\includegraphics[width=5cm]{bib/Izaac.png}};
% TODO: \path(cp) ++(1.5,0.) node[rotate=-10]{\includegraphics[width=5cm]{bib/Allen.png}};
% TODO: TERELL HILL};
...
\path(vu) ++(.2,0) node(B)[align=center]{
  \bf E.D.O.\\[1ex]
  \includegraphics[width=2.8cm]{img/teorias/clasica.png}};
                    
\path(vl) ++(-3.6,-.5) node(C)[align=center]{
  \bf Cuántica\\[1ex]
  \includegraphics[width=4.5cm]{img/teorias/cuantica.png}};
                     
\path(vl) ++(0.8,.8) node(D)[align=center]{
   \bf \hspace{-4ex} Montecarlo\\[1ex]
  \includegraphics[width=3.0cm]{img/teorias/ensemble_n.png}};
                      
\path(hr) ++(1.1,2.2) node(E)[align=center]{
   \bf Dinámca \\
   \bf Molecular\\[1ex]    
  \includegraphics[width=3.0cm]{img/teorias/kinetics_low.png}};
...
\path<2>(se) ++(-.2,.2) node(F)[anchor=south east,align=center]{
  ...
  \includegraphics[width=3.0cm]{img/teorias/advanced.jpg}};
...
\path(A.north east) ++(.1,.1) node[anchor=north east]{\includegraphics[width=1cm]{fortran_logo.png}};
\path(c3) ++(0,.5) node[rotate=10]{\includegraphics[width=5cm]{gente/warning.png}};

\path(c1) ++(0,-1) node(A){\includegraphics[width=4cm]{gente/pancho.png}};
\path(A.north east) ++(.1,.1) node[anchor=north east]{\includegraphics[width=1cm]{python_logo.png}};
...
\path(A.west) ++(0,0) node[anchor=west,opacity=0.06]{\includegraphics[width=5.5cm]{fortran_logo.png}};
...
\path(A.west) ++(0,0) node[anchor=west,opacity=0.06]{\includegraphics[width=5.5cm]{bash_logo.png}};
