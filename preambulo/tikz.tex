...
% Para extraer las coordenadas del ultimo path
\makeatletter
\newcommand{\getlastxy}{%
  \pgfgetlastxy{\x}{\y}
  \pgfmathsetmacro{\x}{\x / \pgf@xx}
  \pgfmathsetmacro{\y}{\y / \pgf@yy}
}
\makeatother
...
calc,% Operar con coordnadas. e.g. ($(0,1)+(1,0)$)
fit,%
patterns,%
plotmarks,%
...
\tikzset{
 ...
 title/.style={name=title,verde,anchor=west,font={\bfseries\Large\color{bg}}},
 ...
 ej/.style={cuadro,draw=lila,fill=lila},
 ejhead/.style={ej,inner sep=4,fill opacity=1,anchor=west,font={\bfseries\color{bg}}},
}
...
\tikzset{
 texto/.style={anchor=north west,align=center},
 title/.style={name=title,verde,anchor=west,font={\bfseries\Large\color{bg}}},
  title/.cd, center/.style={anchor=center,align=center},
 cuadro/.style={execute at begin node=\setlength{\baselineskip}{4ex},rectangle, rounded corners=1ex,fill opacity=0.2,text opacity=1, anchor=north west,inner sep=6,align=left},
 def/.style={cuadro,draw=amarillo,fill=amarillo},
 defhead/.style={def,inner sep=4,fill opacity=1,font={\bfseries\color{bg}}},
 proc/.style={cuadro,draw=verde,fill=verde},
